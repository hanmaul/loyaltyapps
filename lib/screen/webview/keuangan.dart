...
class WebviewKeuangan extends StatefulWidget {
  const WebviewKeuangan({super.key});

  @override
  State<WebviewKeuangan> createState() => _WebviewKeuanganState();
}
...
class _WebviewKeuanganState extends State<WebviewKeuangan> {
